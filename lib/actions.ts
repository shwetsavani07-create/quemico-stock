...
export async function updateProductAction(
  ...
  try {
    ...
    // Keep the existing image unless the user explicitly
    // removes it or uploads a new image.
...
export async function deleteProductAction(
  ...
  try {
    ...
    console.error(
        "[actions] deleteProductAction failed:",
        error,
    );
...
export async function sellStockAction(
  ...
  try {
    ...
    console.error(
        "[actions] sellStockAction failed:",
        error,
    );
...
function isRedirectError(
  ...
  return (
      ...
      error !== null &&
      "digest" in error &&
      typeof (error as { digest?: string }).digest ===
      "string" &&
      (
